...
##	  v0.09		: Changed use of BitsTransfer to Copy-Item since BitsTransfer required certain admin credentials not all users have.
##	  v0.10		: Added test to copy-item function to verify that .vbs scripts had been added to 2003 servers before proceeding. 
##	  v0.11		: Added include.ps1 auto update functionality to script. Unless frontend revisions are neccessitated majority of 
##				  Patch Fix information will be found in include.ps1 
##	  v0.12		: After script is done running will relaunch Launcher.ps1 so tasks can continue to be run. 
