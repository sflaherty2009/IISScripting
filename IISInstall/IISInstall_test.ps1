...
##	  v0.07		: Cleaned up lib file to only have functions associated with IISInstall.
##	  v0.08		: Added include.ps1 auto update functionality to script. Unless frontend revisions are neccessitated majority of 
##				  Patch Fix information will be found in include.ps1 
##	  v0.09		: After script is done running will relaunch Launcher.ps1 so tasks can continue to be run.  
		...
		$choice=$host.ui.PromptForChoice($title, $message, $options, 1)
			...
			switch ($choice){
				0{
					...
					FuncCheckIIS -server $server -cred $cred 
...
#(TESTING) FuncInstallIIS : Function used for the installation of IIS 8/7.5 of server systems remotely. 
