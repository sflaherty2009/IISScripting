...
##	  present. 
##.NOTES 
##    FileName	 :_FunctionList_v0.16.1.ps1 
	  $version = '0.16.1'
...
#(TESTING)function used to pull SSL certs from CertMan and bind them to newly created IIS bindings/sites 
#Called and used by FuncAddWebsite
...
#(TESTING)Prompt and store a users password encrypted in Credential folder if already available return credentials. 
...
#TO DO 
#Check version of current lib against version of lib stored in IISScripting folder. 